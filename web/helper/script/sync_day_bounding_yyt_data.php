 ...
 * $Date: 2010-3-5 下午06:54:37 $
 * $Id: cron.php 8933 2012-05-25 08:26:45Z ninghx $
*/
...
// 默认设置
$log_file                   = '/data/logs/platform_cron.log';           // 计划任务执行信息记录到的log文件默认地址
$log_email                  = 'shenxn@alltosun.com';                  // 定义计划任务发生错误时报告错误日志的默认邮箱
$_SERVER['HTTP_HOST']       = 'platform.alltosun.net';                    // 运行网站使用的域名
...
// 初始化框架
require '/data/framework/tags/1.1.1/init.php';
...
try {
    ...
    // 订单失效
    _widget('equip.equip_day')->day_bounding_yyt();
    _widget('equip.equip_day')->day_awifi_online_yyt();
    _widget('equip.equip_day')->day_api_online_yyt();
