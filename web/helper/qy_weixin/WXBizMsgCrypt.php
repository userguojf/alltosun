...
include_once ROOT_PATH."/helper/qy_weixin/sha1.php";
include_once ROOT_PATH."/helper/qy_weixin/xmlparse.php";
include_once ROOT_PATH."/helper/qy_weixin/pkcs7Encoder.php";
include_once ROOT_PATH."/helper/qy_weixin/errorCode.php";

/**
 * 1.第三方回复加密消息给公众平台；
 * 2.第三方收到公众平台发送的消息，验证消息的安全性，并对消息进行解密。
 */
class WXBizMsgCryptClass
{
	private $m_sToken;
