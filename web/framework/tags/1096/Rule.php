 ...
 * $Id: Rule.php 1031 2015-10-19 07:39:09Z liudh $
*/
...
//        Rule::set('http://{$subdomain=blog|space}.*.com/{$module|get_cities=\w}/{$app=u}/{$visit_id=\d+}/*');

//        Rule::set(array('{$module=blog}/{$app=u}/{$visit_id=\d+}/*'=>'blog/*'));
//        Rule::setAlias(array('{$module=blog}/{$app=u}/{$visit_id=\d+}/*'=>'blog/*'));

//        $alias = array(
//            'culture/*' => 'article/*'
//        );
//        Rule::setAlias($alias);
//        Rule::setRedirect($alias); // 待定
    /*
            ...
            if (!$paramsParsing) {
                ...
                if (is_dir($t_dir)) {
                    ...
                    if (DIRECTORY_SEPARATOR == "\\"){
                        $t_dir = strtr($t_dir, '/', DIRECTORY_SEPARATOR);
                    }
