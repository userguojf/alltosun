...
class KXClient{
	...
	public $redirect_uri = '';//回调地址，所在域名必须与开发者注册应用时所提供的网站根域名列表或应用的站点地址（如果根域名列表没填写）的域名相匹配
     ...
     * Construct method
     */
    function __construct($access_token = null, $params = array()) 
    {
        ...
        $this->client_id = $params[0];
        $this->client_secret = $params[1];
        $this->redirect_uri = $params[2];
    }
