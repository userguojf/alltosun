  ...
  $.fn.fcbkcomplete = function(opt) {
    return this.queue( function() {
      ...
      function elPrepare() {
        ...
        var temp_elem = $('<'+element.get(0).tagName+' name="'+name+'" id="'+elemid+'" multiple="multiple" style="display:none;"class="' + element.get(0).className + ' hidden">').data('cache', {});
      ...
      function addInput(focusme) {
        ...
        var input = $('<input type="text" size="' + options.input_min_size + '" autocomplete="off">');
