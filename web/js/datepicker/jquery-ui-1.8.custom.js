...
function(b) {
  b.ui = {
    ...
    hasScroll: function(c, f) {
      ...
      var d = f && f == "left" ? "scrollLeft": "scrollTop",
      a = false;
  ...
  b.extend(b.expr[":"], {
    ...
    focusable: function(c) {
      ...
      d = b.attr(c, "tabindex");
      return (/input|select|textarea|button|object/.test(f) ? !c.disabled: "a" == f || "area" == f ? c.href || !isNaN(d) : !isNaN(d)) && !b(c)["area" == f ? "parents": "closest"](":hidden").length
    },
    tabbable: function(c) {
  ...
  b.widget = function(f, d, a) {
    ...
    d.options = b.extend({},
    d.options);
    b[e][f].prototype = b.extend(true, d, {
      namespace: e,
      widgetName: f,
  ...
  b.widget.bridge = function(f, d) {
    b.fn[f] = function(a) {
      ...
      e ? this.each(function() {
        var k = b.data(this, f),
        j = k && b.isFunction(k[a]) ? k[a].apply(k, g) : k;
        if (j !== k && j !== undefined) {
          i = j;
          return false
        }
  ...
  b.Widget.prototype = {
    ...
    _createWidget: function(f, d) {
      ...
      this.options, b.metadata && b.metadata.get(d)[this.widgetName], f);
      var a = this;
  ...
  b.widget("ui.mouse", {
    ...
    _mouseDown: function(c) {
      ...
      if (!c.originalEvent.mouseHandled) {
        ...
        var f = this,
        d = c.which == 1,
        a = typeof this.options.cancel == "string" ? b(c.target).parents().add(c.target).filter(this.options.cancel).length: false;
  ...
  b.fn.position = function(e) {
    ...
    e);
    var g = b(e.of),
    i = (e.collision || "flip").split(" "),
    k = e.offset ? e.offset.split(" ") : [0, 0],
    j,
    h,
    l;
    if (e.of.nodeType === 9) {
    ...
    flip: {
      left: function(e, g) {
        if (g.at[0] !== "center") {
          var i = b(window);
          i = e.left + g.elemWidth - i.width() - i.scrollLeft();
          var k = g.my[0] === "left" ? -g.elemWidth: g.my[0] === "right" ? g.elemWidth: 0,
          j = -2 * g.offset[0];
      ...
      top: function(e, g) {
        if (g.at[1] !== "center") {
          var i = b(window);
          i = e.top + g.elemHeight - i.height() - i.scrollTop();
          var k = g.my[1] === "top" ? -g.elemHeight: g.my[1] === "bottom" ? g.elemHeight: 0,
          j = g.at[1] === "top" ? g.targetHeight: -g.targetHeight,
          h = -2 * g.offset[1];
  ...
  if (!b.offset.setOffset) {
    b.offset.setOffset = function(e, g) {
      ...
      var i = b(e),
      k = i.offset(),
      j = parseInt(b.curCSS(e, "top", true), 10) || 0,
      h = parseInt(b.curCSS(e, "left", true), 10) || 0;
      k = {
        top: g.top - k.top + j,
  ...
  b.widget("ui.draggable", b.ui.mouse, {
    ...
    _convertPositionTo: function(c, f) {
      ...
      e = /(html|body)/i.test(a[0].tagName);
      return {
        ...
        left: f.left + this.offset.relative.left * d + this.offset.parent.left * d - (b.browser.safari && b.browser.version < 526 && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : e ? 0 : a.scrollLeft()) * d)
      }
    },
    _generatePosition: function(c) {
      ...
      return {
        ...
        left: e - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (b.browser.safari && b.browser.version < 526 && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : a ? 0 : d.scrollLeft())
      }
    },
    _clear: function() {
  ...
  b.ui.plugin.add("draggable", "scroll", {
    ...
    drag: function(c) {
      ...
      if (f.scrollParent[0] != document && f.scrollParent[0].tagName != "HTML") {
        ...
        if (!d.axis || d.axis != "y") if (f.overflowOffset.left + f.scrollParent[0].offsetWidth - c.pageX < d.scrollSensitivity) f.scrollParent[0].scrollLeft = a = f.scrollParent[0].scrollLeft + d.scrollSpeed;
        ...
        if (!d.axis || d.axis != "y") if (c.pageX - b(document).scrollLeft() < d.scrollSensitivity) a = b(document).scrollLeft(b(document).scrollLeft() - d.scrollSpeed);
  ...
  b.ui.plugin.add("draggable", "snap", {
    ...
    drag: function(c, f) {
      for (var d = b(this).data("draggable"), a = d.options, e = a.snapTolerance, g = f.offset.left, i = g + d.helperProportions.width, k = f.offset.top, j = k + d.helperProportions.height, h = d.snapElements.length - 1; h >= 0; h--) {
        var l = d.snapElements[h].left,
        m = l + d.snapElements[h].width,
        n = d.snapElements[h].top,
        o = n + d.snapElements[h].height;
        if (l - e < g && g < m + e && n - e < k && k < o + e || l - e < g && g < m + e && n - e < j && j < o + e || l - e < i && i < m + e && n - e < k && k < o + e || l - e < i && i < m + e && n - e < j && j < o + e) {
          if (a.snapMode != "inner") {
  ...
  b.widget("ui.droppable", {
    ...
    _drop: function(c, f) {
      ...
      if (this.accept.call(this.element[0], d.currentItem || d.element)) {
        this.options.activeClass && this.element.removeClass(this.options.activeClass);
        this.options.hoverClass && this.element.removeClass(this.options.hoverClass);
        this._trigger("drop", c, this.ui(d));
        return this.element
      }
      return false
    },
  ...
  b.ui.intersect = function(c, f, d) {
    ...
    var a = (c.positionAbs || c.position.absolute).left,
    e = a + c.helperProportions.width,
    g = (c.positionAbs || c.position.absolute).top,
    i = g + c.helperProportions.height,
    k = f.offset.left,
    j = k + f.proportions.width,
    h = f.offset.top,
    l = h + f.proportions.height;
    switch (d) {
    case "fit":
      return k < a && e < j && h < g && i < l;
    case "intersect":
  ...
  b.ui.ddmanager = {
    ...
    prepareOffsets: function(c, f) {
      var d = b.ui.ddmanager.droppables[c.options.scope] || [],
      a = f ? f.type: null,
  ...
  b.widget("ui.resizable", b.ui.mouse, {
    ...
    _create: function() {
      ...
      if (this.handles.constructor == String) {
        ...
        for (var g = 0; g < e.length; g++) {
          var i = b.trim(e[g]),
          k = b('<div class="ui-resizable-handle ' + ("ui-resizable-" + i) + '"></div>');
      ...
      this._renderAxis = function(j) {
        ...
        for (var h in this.handles) {
          if (this.handles[h].constructor == String) this.handles[h] = b(this.handles[h], this.element).show();
          if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i)) {
            var l = b(this.handles[h], this.element),
            m = 0;
    ...
    _respectSize: function(d) {
      var a = this.options,
      e = this.axis,
      g = f(d.width) && a.maxWidth && a.maxWidth < d.width,
      i = f(d.height) && a.maxHeight && a.maxHeight < d.height,
      k = f(d.width) && a.minWidth && a.minWidth > d.width,
      j = f(d.height) && a.minHeight && a.minHeight > d.height;
    ...
    _proportionallyResize: function() {
      if (this._proportionallyResizeElements.length) for (var d = this.helper || this.element,
      a = 0; a < this._proportionallyResizeElements.length; a++) {
        ...
        if (!this.borderDif) {
          ...
          this.borderDif = b.map(g,
          function(k, j) {
            var h = parseInt(k, 10) || 0,
            l = parseInt(i[j], 10) || 0;
            return h + l
          })
        }
    ...
    _renderProxy: function() {
      ...
      if (this._helper) {
        ...
        var a = b.browser.msie && b.browser.version < 7,
        e = a ? 1 : 0;
        a = a ? 2 : -1;
    ...
    _change: {
      ...
      sw: function(d, a, e) {
        return b.extend(this._change.s.apply(this, arguments), this._change.w.apply(this, [d, a, e]))
      },
      ne: function(d, a, e) {
  ...
  b.ui.plugin.add("resizable", "alsoResize", {
    start: function() {
      var d = b(this).data("resizable").options,
      a = function(e) {
        b(e).each(function() {
    ...
    resize: function() {
      ...
      typeof a.alsoResize == "object" && !a.alsoResize.nodeType ? b.each(a.alsoResize,
      function(j, h) {
        k(j, h)
      }) : k(a.alsoResize)
    },
  ...
  b.ui.plugin.add("resizable", "animate", {
    stop: function(d) {
      ...
      e = a.options,
      g = a._proportionallyResizeElements,
      i = g.length && /textarea/i.test(g[0].nodeName),
      k = i && b.ui.hasScroll(g[0], "left") ? 0 : a.sizeDiff.height;
      i = {
      ...
      a.element.animate(b.extend(i, j && k ? {
        top: j,
        left: k
      }: {}), {
  ...
  b.ui.plugin.add("resizable", "containment", {
    start: function() {
      var d = b(this).data("resizable"),
      a = d.element,
      e = d.options.containment;
      if (a = e instanceof b ? e.get(0) : /parent/.test(e) ? a.parent().get(0) : e) {
        ...
        if (/document/.test(e) || e == document) {
          ...
          d.containerSize = {
            height: g.innerHeight() - i[3],
            width: g.innerWidth() - i[1]
          };
          e = d.containerOffset;
          var k = d.containerSize.height,
          j = d.containerSize.width;
    ...
    resize: function(d) {
      ...
      g = Math.abs((a._helper ? a.offset.top - k.top: a.offset.top - g.top) + a.sizeDiff.height);
    ...
    stop: function() {
      ...
      k = b(d.helper),
      j = k.offset(),
      h = k.outerWidth() - d.sizeDiff.width;
  ...
  b.widget("ui.sortable", b.ui.mouse, {
    ...
    _mouseDrag: function(c) {
      ...
      if (this.options.scroll) {
        ...
        if (this.scrollParent[0] != document && this.scrollParent[0].tagName != "HTML") {
          ...
          else if (c.pageX - this.overflowOffset.left < f.scrollSensitivity) this.scrollParent[0].scrollLeft = d = this.scrollParent[0].scrollLeft - f.scrollSpeed
        } else {
          ...
          else if (b(window).width() - (c.pageX - b(document).scrollLeft()) < f.scrollSensitivity) d = b(document).scrollLeft(b(document).scrollLeft() + f.scrollSpeed)
        }
    ...
    serialize: function(c) {
      ...
      c = c || {};
      b(f).each(function() {
        var a = (b(c.item || this).attr(c.attribute || "id") || "").match(c.expression || /(.+)[-=_](.+)/);
    ...
    _intersectsWith: function(c) {
      ...
      d = f + this.helperProportions.width,
      a = this.positionAbs.top,
      e = a + this.helperProportions.height,
      g = c.left,
      i = g + c.width,
      k = c.top,
      j = k + c.height,
    ...
    refreshPositions: function(c) {
      ...
      for (var f = this.items.length - 1; f >= 0; f--) {
        var d = this.items[f],
        a = this.options.toleranceElement ? b(this.options.toleranceElement, d.item) : d.item;
        if (!c) {
    ...
    _createPlaceholder: function(c) {
      ...
      if (!d.placeholder || d.placeholder.constructor == String) {
        ...
        d.placeholder = {
          element: function() {
            var e = b(document.createElement(f.currentItem[0].nodeName)).addClass(a || f.currentItem[0].className + " ui-sortable-placeholder").removeClass("ui-sortable-helper")[0];
          ...
          update: function(e, g) {
            if (! (a && !d.forcePlaceholderSize)) {
              ...
              g.width() || g.width(f.currentItem.innerWidth() - parseInt(f.currentItem.css("paddingLeft") || 0, 10) - parseInt(f.currentItem.css("paddingRight") || 0, 10))
            }
          }
        }
      }
    ...
    _contactContainers: function(c) {
      for (var f = null,
      d = null,
      a = this.containers.length - 1; a >= 0; a--) if (!b.ui.contains(this.currentItem[0], this.containers[a].element[0])) if (this._intersectsWith(this.containers[a].containerCache)) {
        if (! (f && b.ui.contains(this.containers[a].element[0], f.element[0]))) {
          f = this.containers[a];
          d = a
        }
      } else if (this.containers[a].containerCache.over) {
        this.containers[a]._trigger("out", c, this._uiHash(this));
    ...
    _convertPositionTo: function(c, f) {
      ...
      return {
        ...
        left: f.left + this.offset.relative.left * d + this.offset.parent.left * d - (b.browser.safari && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : e ? 0 : a.scrollLeft()) * d)
      }
    },
    _generatePosition: function(c) {
      var f = this.options,
      ...
      return {
        top: g - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (b.browser.safari && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : a ? 0 : d.scrollTop()),
    ...
    _clear: function(c, f) {
      ...
      var d = []; ! this._noFinalSort && this.currentItem[0].parentNode && this.placeholder.before(this.currentItem);
  ...
  b.widget("ui.accordion", {
    ...
    _create: function() {
      ...
      this.headers = this.element.find(c.header).addClass("ui-accordion-header ui-helper-reset ui-state-default ui-corner-all").bind("mouseenter.accordion",
      function() {
      ...
      c.event && this.headers.bind(c.event + ".accordion",
      function(e) {
    ...
    animations: {
      slide: function(c, f) {
        ...
        if (c.toHide.size()) if (c.toShow.size()) {
          ...
          function(j, h) {
            g[h] = "hide";
            var l = ("" + b.css(c.toShow[0], h)).match(/^([\d+-.]+)(.*)$/);
            e[h] = {
              value: l[1],
              unit: l[2] || "px"
            }
    ...
    _create: function() {
      ...
      this.menu = b("<ul></ul>").addClass("ui-autocomplete").appendTo("body", f).menu({
        ...
        selected: function(d, a) {
          ...
          c.close(d);
          c.previous = c.element.val();
          c.element[0] !== f.activeElement && c.element.focus()
        },
        blur: function() {
  ...
  b.widget("ui.menu", {
    ...
    activate: function(c) {
      ...
      if (this.hasScroll()) {
        ...
        if (f < 0) this.element.attr("scrollTop", d + f);
        else f > a && this.element.attr("scrollTop", d + f - a + c.height())
      }
  ...
  b.widget("ui.button", {
    ...
    _create: function() {
      ...
      i = "ui-state-hover" + (!g ? " ui-state-active": "");
      ...
      g && this.element.bind("change.button",
      function() {
        a.refresh()
      });
    ...
    _resetButton: function() {
      if (this.type === "input") this.options.label && this.element.val(this.options.label);
        ...
        e = b("<span></span>").addClass("ui-button-text").html(this.options.label).appendTo(a.empty()).text(),
        g = this.options.icons,
        i = g.primary && g.secondary;
  ...
  b.widget("ui.dialog", {
    ...
    _create: function() {
      ...
      var c = this,
      f = c.options,
      d = f.title || c.originalTitle || "&#160;",
      a = b.ui.dialog.getTitleId(c.element),
      e = (c.uiDialog = b("<div></div>")).appendTo(document.body).hide().addClass("ui-dialog ui-widget ui-widget-content ui-corner-all " + f.dialogClass).css({
        zIndex: f.zIndex
      ...
      function() {
        ...
        c.close(k);
        return false
      }).appendTo(g); (c.uiDialogTitlebarCloseText = b("<span></span>")).addClass("ui-icon ui-icon-closethick").text(f.closeText).appendTo(i);
      b("<span></span>").addClass("ui-dialog-title").attr("id", a).html(d).prependTo(g);
    ...
    close: function(c) {
      ...
      if (false !== f._trigger("beforeClose", c)) {
        ...
        f._isOpen = false;
        if (f.options.hide) f.uiDialog.hide(f.options.hide,
        function() {
          f._trigger("close", c)
        });
        else {
        ...
        if (f.options.modal) {
          ...
          b(".ui-dialog").each(function() {
            if (this !== f.uiDialog[0]) d = Math.max(d, b(this).css("z-index"))
          });
          b.ui.dialog.maxZ = d
        }
        return f
    ...
    open: function() {
      if (!this._isOpen) {
        ...
        f.show(c.show);
        this.moveToTop(true);
        c.modal && f.bind("keypress.ui-dialog",
        function(d) {
          if (d.keyCode === b.ui.keyCode.TAB) {
            var a = b(":tabbable", this),
            e = a.filter(":first");
            a = a.filter(":last");
            if (d.target === a[0] && !d.shiftKey) {
              e.focus(1);
              return false
    ...
    _createButtons: function(c) {
      var f = this,
      d = false,
      a = b("<div></div>").addClass("ui-dialog-buttonpane ui-widget-content ui-helper-clearfix");
      f.uiDialog.find(".ui-dialog-buttonpane").remove();
      typeof c === "object" && c !== null && b.each(c,
      function() {
        return ! (d = true)
      });
      if (d) {
    ...
    _setOption: function(c, f) {
      ...
      case "dialogClass":
        ...
        break;
      case "disabled":
        f ? d.addClass("ui-dialog-disabled") : d.removeClass("ui-dialog-disabled");
        break;
      case "draggable":
      ...
      case "resizable":
        ...
        a && typeof f === "string" && d.resizable("option", "handles", f); ! a && f !== false && this._makeResizable(f);
        break;
      case "title":
    ...
    _size: function() {
      ...
      this.element.css(c.height === "auto" ? {
        minHeight: Math.max(c.minHeight - f, 0),
        height: "auto"
      }: {
        minHeight: 0,
  ...
  b.extend(b.ui.dialog.overlay, {
    ...
    width: function() {
      ...
      if (b.browser.msie && b.browser.version < 7) {
        ...
        return c < f ? b(window).width() + "px": c + "px"
  ...
  b.widget("ui.slider", b.ui.mouse, {
    ...
    values: function(c, f) {
      ...
      if (arguments.length) if (b.isArray(arguments[0])) {
        for (var d = this.options.values,
        a = arguments[0], e = 0, g = d.length; e < g; e++) {
    ...
    _values: function(c) {
      if (arguments.length) {
        var f = this.options.values[c];
        return f = this._trimValue(f)
      } else {
        f = this.options.values.slice();
        for (var d = 0,
        a = f.length; d < a; d++) f[d] = this._trimValue(f[d]);
        return f
      }
    },
    ...
    _refreshValue: function() {
      ...
      f = this.options,
      d = this,
      a = !this._animateOff ? f.animate: false;
      if (this.options.values && this.options.values.length) this.handles.each(function(k) {
        var j = (d.values(k) - d._valueMin()) / (d._valueMax() - d._valueMin()) * 100,
        h = {};
  ...
  b.widget("ui.tabs", {
    ...
    _setOption: function(d, a) {
      if (d == "selected") this.options.collapsible && a == this.options.selected || this.select(a);
      else {
        this.options[d] = a;
        this._tabify()
      }
    ...
    _tabify: function(d) {
      ...
      this.anchors.each(function(o, p) {
        ...
        r = q.split("#")[0],
        s;
        if (r && (r === location.toString().split("#")[0] || (s = b("base")[0]) && r === s.href)) {
          q = p.hash;
          p.href = q
        }
      ...
      if (d) {
        ...
        if (g.selected === undefined) {
          ...
          if (typeof g.selected != "number" && this.lis.filter(".ui-tabs-selected").length) g.selected = this.lis.index(this.lis.filter(".ui-tabs-selected"));
        ...
        g.disabled = b.unique(g.disabled.concat(b.map(this.lis.filter(".ui-state-disabled"),
        function(o) {
      ...
      function(o, p) {
        ...
        p.hide().removeClass("ui-tabs-hide").animate(l, l.duration || "normal",
        function() {
          a(p, l);
      ...
      this.anchors.bind(g.event + ".tabs",
      function() {
        var o = this,
        p = b(this).closest("li"),
        q = e.panels.filter(":not(.ui-tabs-hide)"),
        r = b(e._sanitizeSelector(this.hash));
    ...
    remove: function(d) {
      ...
      this._tabify();
      this._trigger("remove", null, this._ui(e.find("a")[0], g[0]));
      return this
    },
    enable: function(d) {
      var a = this.options;
    ...
    load: function(d) {
      var a = this,
      e = this.options,
      g = this.anchors.eq(d)[0],
      i = b.data(g, "load.tabs");
      this.abort();
  ...
  b.extend(b.ui.tabs.prototype, {
    ...
    rotate: function(d, a) {
      var e = this,
      g = this.options,
      i = e._rotate || (e._rotate = function(j) {
  ...
  b.extend(c.prototype, {
    ...
    _attachDatepicker: function(a, e) {
      ...
      e || {},
      g || {});
      if (i == "input") this._connectDatepicker(a, h);
      else k && this._inlineDatepicker(a, h)
    },
    ...
    _connectDatepicker: function(a, e) {
      ...
      if (!g.hasClass(this.markerClassName)) {
        ...
        g.addClass(this.markerClassName).keydown(this._doKeyDown).keypress(this._doKeyPress).keyup(this._doKeyUp).bind("setData.datepicker",
        function(i, k, j) {
          e.settings[k] = j
    ...
    _attachments: function(a, e) {
      ...
      if (g == "button" || g == "both") {
        ...
        e.trigger = b(this._get(e, "buttonImageOnly") ? b("<img/>").addClass(this._triggerClass).attr({
          ...
          alt: g,
          title: g
        }) : b('<button type="button"></button>').addClass(this._triggerClass).html(k == "" ? g: b("<img/>").attr({
          src: k,
          alt: g,
          title: g
        })));
      ...
      if (this._get(a, "autoSize") && !a.inline) {
        ...
        if (g.match(/[DM]/)) {
          var i = function(k) {
            for (var j = 0,
            h = 0,
            l = 0; l < k.length; l++) if (k[l].length > j) {
              j = k[l].length;
              h = l
            }
            return h
          };
          e.setMonth(i(this._get(a, g.match(/MM/) ? "monthNames": "monthNamesShort")));
    ...
    _inlineDatepicker: function(a, e) {
      var g = b(a);
      if (!g.hasClass(this.markerClassName)) {
        g.addClass(this.markerClassName).append(e.dpDiv).bind("setData.datepicker",
        function(i, k, j) {
          e.settings[k] = j
        }).bind("getData.datepicker",
        function(i, k) {
    ...
    _optionDatepicker: function(a, e, g) {
      ...
      if (arguments.length == 2 && typeof e == "string") return e == "defaults" ? b.extend({},
      b.datepicker._defaults) : i ? e == "all" ? b.extend({},
      i.settings) : this._get(i, e) : null;
      var k = e || {};
      if (typeof e == "string") {
        k = {};
        k[e] = g
    ...
    _showDatepicker: function(a) {
      ...
      if (! (b.datepicker._isDisabledDatepicker(a) || b.datepicker._lastInput == a)) {
        ...
        if (!e.inline) {
          ...
          var k = b.datepicker._get(e, "duration"),
          j = function() {
          ...
          b.effects && b.effects[g] ? e.dpDiv.show(g, b.datepicker._get(e, "showOptions"), k, j) : e.dpDiv[g || "show"](g ? k: null, j);
          if (!g || !k) j();
    ...
    _updateDatepicker: function(a) {
      var e = this,
      g = b.datepicker._getBorders(a.dpDiv);
    ...
    _checkOffset: function(a, e, g) {
      ...
      k = a.dpDiv.outerHeight(),
      j = a.input ? a.input.outerWidth() : 0,
    ...
    _hideDatepicker: function(a) {
      ...
      if (! (!e || a && e != b.data(a, "datepicker"))) if (this._datepickerShowing) {
        ...
        a || i();
        if (a = this._get(e, "onClose")) a.apply(e.input ? e.input[0] : null, [e.input ? e.input.val() : "", e]);
    ...
    _selectDate: function(a, e) {
      ...
      if (i) i.apply(g.input ? g.input[0] : null, [e, g]);
      else g.input && g.input.trigger("change");
    ...
    _updateAlternate: function(a) {
      ...
      if (e) {
        ...
        i = this._getDate(a),
        k = this.formatDate(g, i, this._getFormatConfig(a));
        b(e).each(function() {
          b(this).val(k)
        })
      }
    ...
    parseDate: function(a, e, g) {
      ...
      if (e == "") return null;
      for (var i = (g ? g.shortYearCutoff: null) || this._defaults.shortYearCutoff, k = (g ? g.dayNamesShort: null) || this._defaults.dayNamesShort, j = (g ? g.dayNames: null) || this._defaults.dayNames, h = (g ? g.monthNamesShort: null) || this._defaults.monthNamesShort, l = (g ? g.monthNames: null) || this._defaults.monthNames, m = g = -1, n = -1, o = -1, p = false, q = function(v) { (v = C + 1 < a.length && a.charAt(C + 1) == v) && C++;
        return v
      },
      r = function(v) {
        q(v);
        ...
        if (!v) throw "Missing number at position " + x;
        x += v[0].length;
      ...
      x = 0, C = 0; C < a.length; C++) if (p) if (a.charAt(C) == "'" && !q("'")) p = false;
      else u();
      ...
      z = this._daylightSavingAdjust(new Date(g, m - 1, n));
    ...
    formatDate: function(a, e, g) {
      if (!e) return "";
      var i = (g ? g.dayNamesShort: null) || this._defaults.dayNamesShort,
      k = (g ? g.dayNames: null) || this._defaults.dayNames,
      j = (g ? g.monthNamesShort: null) || this._defaults.monthNamesShort;
      g = (g ? g.monthNames: null) || this._defaults.monthNames;
      var h = function(q) { (q = p + 1 < a.length && a.charAt(p + 1) == q) && p++;
        return q
      },
      l = function(q, r, s) {
        r = "" + r;
      ...
      n = "",
      o = false;
      if (e) for (var p = 0; p < a.length; p++) if (o) if (a.charAt(p) == "'" && !h("'")) o = false;
      else n += a.charAt(p);
    ...
    _possibleChars: function(a) {
      for (var e = "",
      g = false,
      i = function(j) { (j = k + 1 < a.length && a.charAt(k + 1) == j) && k++;
        return j
      },
      k = 0; k < a.length; k++) if (g) if (a.charAt(k) == "'" && !i("'")) g = false;
      else e += a.charAt(k);
    ...
    _determineDate: function(a, e, g) {
      ...
      k = function(j) {
        ...
        var l = (j.toLowerCase().match(/^c/) ? b.datepicker._getDate(a) : null) || new Date,
        m = l.getFullYear(),
        n = l.getMonth();
        l = l.getDate();
        for (var o = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g,
        p = o.exec(j); p;) {
          switch (p[2] || "d") {
          case "d":
          case "D":
    ...
    _generateHTML: function(a) {
      ...
      var g = this._get(a, "isRTL"),
      i = this._get(a, "showButtonPanel"),
      k = this._get(a, "hideIfNoPrevNext"),
      j = this._get(a, "navigationAsDateFormat"),
      ...
      u = !j ? u: this.formatDate(u, this._daylightSavingAdjust(new Date(r, l + m, 1)), this._getFormatConfig(a));
      ...
      u = this._get(a, "gotoCurrent") && a.currentDay ? o: e;
      ...
      i = i ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (g ? j: "") + (this._isInRange(a, u) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_' + d + ".datepicker._gotoToday('#" + a.id + "');\">" + m + "</button>": "") + (g ? "": j) + "</div>": "";
      j = parseInt(this._get(a, "firstDay"), 10);
      j = isNaN(j) ? 0 : j;
      m = this._get(a, "showWeek");
      u = this._get(a, "dayNames");
      this._get(a, "dayNamesShort");
      var x = this._get(a, "dayNamesMin"),
      C = this._get(a, "monthNames"),
      z = this._get(a, "monthNamesShort"),
      v = this._get(a, "beforeShowDay"),
      A = this._get(a, "showOtherMonths"),
      I = this._get(a, "selectOtherMonths");
      this._get(a, "calculateWeek");
      for (var L = this._getDefaultDate(a), J = "", F = 0; F < h[0]; F++) {
        for (var M = "",
        G = 0; G < h[1]; G++) {
          var N = this._daylightSavingAdjust(new Date(r, l, a.selectedDay)),
          y = " ui-corner-all",
          B = "";
          if (n) {
            ...
            case 0:
              ...
              break;
            case h[1] - 1 : B += " ui-datepicker-group-last";
          ...
          B += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + y + '">' + (/all|left/.test(y) && F == 0 ? g ? k: s: "") + (/all|right/.test(y) && F == 0 ? g ? s: k: "") + this._generateMonthYearHeader(a, l, r, p, q, F > 0 || G > 0, C, z) + '</div><table class="ui-datepicker-calendar"><thead><tr>';
          ...
          if (r == a.selectedYear && l == a.selectedMonth) a.selectedDay = Math.min(a.selectedDay, D);
          ...
          for (var O = 0; O < D; O++) {
            ...
            for (y = 0; y < 7; y++) {
              var H = v ? v.apply(a.input ? a.input[0] : null, [w]) : [true, ""],
              E = w.getMonth() != l,
              K = E && !I || !H[0] || p && w < p || q && w > q;
              P += '<td class="' + ((y + j + 6) % 7 >= 5 ? " ui-datepicker-week-end": "") + (E ? " ui-datepicker-other-month": "") + (w.getTime() == N.getTime() && l == a.selectedMonth && a._keyEvent || L.getTime() == w.getTime() && L.getTime() == N.getTime() ? " " + this._dayOverClass: "") + (K ? " " + this._unselectableClass + " ui-state-disabled": "") + (E && !A ? "": " " + H[1] + (w.getTime() == o.getTime() ? " " + this._currentClass: "") + (w.getTime() == e.getTime() ? " ui-datepicker-today": "")) + '"' + ((!E || A) && H[2] ? ' title="' + H[2] + '"': "") + (K ? "": ' onclick="DP_jQuery_' + d + ".datepicker._selectDay('#" + a.id + "'," + w.getMonth() + "," + w.getFullYear() + ', this);return false;"') + ">" + (E && !A ? "&#xa0;": K ? '<span class="ui-state-default">' + w.getDate() + "</span>": '<a class="ui-state-default' + (w.getTime() == e.getTime() ? " ui-state-highlight": "") + (w.getTime() == o.getTime() ? " ui-state-active": "") + (E ? " ui-priority-secondary": "") + '" href="#">' + w.getDate() + "</a>") + "</td>";
    ...
    _generateMonthYearHeader: function(a, e, g, i, k, j, h, l) {
      ...
      if (j || !m) q += '<span class="ui-datepicker-month">' + h[e] + "</span>";
        ...
        q += '<select class="ui-datepicker-month" onchange="DP_jQuery_' + d + ".datepicker._selectMonthYear('#" + a.id + "', this, 'M');\" onclick=\"DP_jQuery_" + d + ".datepicker._clickMonthYear('#" + a.id + "');\">";
    ...
    _adjustInstDate: function(a, e, g) {
      var i = a.drawYear + (g == "Y" ? e: 0),
      k = a.drawMonth + (g == "M" ? e: 0);
    ...
    _restrictMinMax: function(a, e) {
      var g = this._getMinMaxDate(a, "min"),
...
function(b) {
  function c(j) {
    ...
    if (h = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(j)) return [parseInt(h[1], 16), parseInt(h[2], 16), parseInt(h[3], 16)];
  ...
  function(j, h) {
    b.fx.step[h] = function(l) {
      ...
      l.elem.style[h] = "rgb(" + Math.max(Math.min(parseInt(l.pos * (l.end[0] - l.start[0]) + l.start[0], 10), 255), 0) + "," + Math.max(Math.min(parseInt(l.pos * (l.end[1] - l.start[1]) + l.start[1], 10), 255), 0) + "," + Math.max(Math.min(parseInt(l.pos * (l.end[2] - l.start[2]) + l.start[2], 10), 255), 0) + ")"
    }
  });
  var g = {
    aqua: [0, 255, 255],
  ...
  b.extend(b.effects, {
    version: "1.8",
    save: function(j, h) {
      for (var l = 0; l < h.length; l++) h[l] !== null && j.data("ec.storage." + h[l], j[0].style[h[l]])
    },
  ...
  b.fn.extend({
    ...
    _show: b.fn.show,
    show: function(j) {
      if (!j || typeof j == "number" || b.fx.speeds[j]) return this._show.apply(this, arguments);
      else {
        var h = e.apply(this, arguments);
        h[1].mode = "show";
    ...
    toggle: function(j) {
      if (!j || typeof j == "number" || b.fx.speeds[j] || typeof j == "boolean" || b.isFunction(j)) return this.__toggle.apply(this, arguments);
      else {
        var h = e.apply(this, arguments);
        h[1].mode = "toggle";
        return this.effect.apply(this, h)
  ...
  b.extend(b.easing, {
    ...
    easeInOutQuad: function(j, h, l, m, n) {
    ...
    easeInExpo: function(j, h, l, m, n) {
      return h == 0 ? l: m * Math.pow(2, 10 * (h / n - 1)) + l
    },
    ...
    easeInOutCirc: function(j, h, l, m, n) {
      ...
      return m / 2 * (Math.sqrt(1 - (h -= 2) * h) + 1) + l
    },
    ...
    easeInOutElastic: function(j, h, l, m, n) {
      j = 1.70158;
      var o = 0,
      p = m;
      if (h == 0) return l;
    ...
    easeInOutBack: function(j, h, l, m, n, o) {
      if (o == undefined) o = 1.70158;
    ...
    easeInOutBounce: function(j, h, l, m, n) {
      if (h < n / 2) return b.easing.easeInBounce(j, h * 2, 0, m, n) * 0.5 + l;
  ...
  b.effects.blind = function(c) {
    return this.queue(function() {
      var f = b(this),
      d = ["position", "top", "left"],
      a = b.effects.setMode(f, c.options.mode || "hide"),
      e = c.options.direction || "vertical";
      b.effects.save(f, d);
      f.show();
      ...
      var k = {};
      k[i] = a == "show" ? e: 0;
      g.animate(k, c.duration, c.options.easing,
      function() {
        a == "hide" && f.hide();
  ...
  b.effects.bounce = function(c) {
    return this.queue(function() {
      var f = b(this),
      d = ["position", "top", "left"],
      a = b.effects.setMode(f, c.options.mode || "effect"),
      e = c.options.direction || "up",
  ...
  b.effects.explode = function(c) {
    return this.queue(function() {
      ...
      d = c.options.pieces ? Math.round(Math.sqrt(c.options.pieces)) : 3;
      c.options.mode = c.options.mode == "toggle" ? b(this).is(":visible") ? "hide": "show": c.options.mode;
      var a = b(this).show().css("visibility", "hidden"),
      e = a.offset();
      e.top -= parseInt(a.css("marginTop"), 10) || 0;
      e.left -= parseInt(a.css("marginLeft"), 10) || 0;
      for (var g = a.outerWidth(true), i = a.outerHeight(true), k = 0; k < f; k++) for (var j = 0; j < d; j++) a.clone().appendTo("body").wrap("<div></div>").css({
        position: "absolute",
        visibility: "visible",
        left: -j * (g / d),
        top: -k * (i / f)
        ...
        top: e.top + k * (i / f) + (c.options.mode == "show" ? 0 : (k - Math.floor(f / 2)) * (i / f)),
  ...
  b.effects.fold = function(c) {
    return this.queue(function() {
      ...
      i = c.duration ? c.duration / 2 : b.fx.speeds._default / 2;
      b.effects.save(f, d);
      f.show();
      ...
      j = a == "show" != g,
      h = j ? ["width", "height"] : ["height", "width"];
      j = j ? [k.width(), k.height()] : [k.height(), k.width()];
      var l = /([0-9]+)%/.exec(e);
      if (l) e = parseInt(l[1], 10) / 100 * j[a == "hide" ? 0 : 1];
      if (a == "show") k.css(g ? {
        height: 0,
        width: e
      }: {
      ...
      g[h[0]] = a == "show" ? j[0] : e;
      l[h[1]] = a == "show" ? j[1] : 0;
      k.animate(g, i, c.options.easing).animate(l, i, c.options.easing,
      function() {
        a == "hide" && f.hide();
        b.effects.restore(f, d);
        b.effects.removeWrapper(f);
  ...
  b.effects.highlight = function(c) {
    return this.queue(function() {
      ...
      a = b.effects.setMode(f, c.options.mode || "show"),
      e = {
      ...
      f.show().css({
        ...
        complete: function() {
          a == "hide" && f.hide();
          b.effects.restore(f, d);
          a == "show" && !b.support.opacity && this.style.removeAttribute("filter");
          c.callback && c.callback.apply(this, arguments);
          f.dequeue()
        }
      })
  ...
  b.effects.pulsate = function(c) {
    return this.queue(function() {
      var f = b(this),
      d = b.effects.setMode(f, c.options.mode || "show");
  ...
  b.effects.puff = function(c) {
    return this.queue(function() {
      var f = b(this),
      d = b.effects.setMode(f, c.options.mode || "hide"),
      a = parseInt(c.options.percent, 10) || 150,
      e = a / 100,
      g = {
        height: f.height(),
        width: f.width()
  ...
  b.effects.scale = function(c) {
    return this.queue(function() {
      ...
      c.options),
      a = b.effects.setMode(f, c.options.mode || "effect"),
      e = parseInt(c.options.percent, 10) || (parseInt(c.options.percent, 10) == 0 ? 0 : a == "hide" ? 0 : 100),
  ...
  b.effects.size = function(c) {
    return this.queue(function() {
      ...
      a = ["position", "top", "left", "overflow", "opacity"],
      ...
      h = c.options.restore || false,
      l = c.options.scale || "both",
      m = c.options.origin,
      n = {
        height: f.height(),
        width: f.width()
      ...
      if (l == "content" || l == "both") {
        ...
        f.find("*[width]").each(function() {
          ...
          if (o.from.y != o.to.y) {
            ...
            child.to = b.effects.setTransition(child, i, o.to.y, child.to)
          }
          if (o.from.x != o.to.x) {
  ...
  b.effects.shake = function(c) {
    return this.queue(function() {
      ...
      g = c.options.times || 3,
      i = c.duration || c.options.duration || 140;
      b.effects.save(f, d);
      f.show();
      b.effects.createWrapper(f);
      var k = a == "up" || a == "down" ? "top": "left",
      j = a == "up" || a == "left" ? "pos": "neg";
      a = {};
      var h = {},
      l = {};
      a[k] = (j == "pos" ? "-=": "+=") + e;
      ...
      f.animate(h, i, c.options.easing).animate(a, i / 2, c.options.easing,
      function() {
        b.effects.restore(f, d);
        b.effects.removeWrapper(f);
        c.callback && c.callback.apply(this, arguments)
  ...
  b.effects.transfer = function(c) {
    return this.queue(function() {
      ...
      var e = b('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(c.options.className).css({
        ...
        width: f.innerWidth(),
        position: "absolute"
      }).animate(d, c.duration, c.options.easing,
      function() {
        e.remove();
        c.callback && c.callback.apply(f[0], arguments);
        f.dequeue()
