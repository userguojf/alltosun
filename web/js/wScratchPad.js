	...
	ScratchPad.prototype = 
	{
		...
		drawImage: function(imagePath)
		{
			...
			var img = new Image();
  			img.src = imagePath;
  			$(img).load(function(){
  				$this.ctx.drawImage(img, 0, 0, 320, 506, 0,0, $this.canvas.width, $this.canvas.height);
  			console.log($this.canvas.width,$this.canvas.height,$(window).height(),$(window).width(),$this);
  				$this.setBgImage();
  			})
		},
