...
var originPic = 'http://201711awifiprobe.alltosun.net/images/meal_background/20180512124600-0.png';
mc.background(originPic, {
...
//    originPic = 'http://201711awifiprobe.alltosun.net/upload/2018/07/10/middle_20180710101459000000_1_15498_59.jpg';

    commonOps.options.pos.y = parseInt(commonOps.options.pos.y) - btn_y;

//    resetPic()
    mcDraw(commonOps, commonType);
});
...
$('.btn-left').on('click', function () {
    btnLock();
    commonOps.options.pos.x = parseInt(commonOps.options.pos.x) - btn_x;
...
function commonFun($this)
{
	commonOps = $this.data('ops');
	commonType = $this.data('type');

    writeWord = $('.writeWord').val();
    var writeWidth = $('.writeWidth').val();
    commonOps.options.width = writeWidth;

    // 获取文字writeWidth
    writeWord = $('.writeWord').val();

    commonOps.text = writeWord;
    commonOps.options.pos.x=90;
    commonOps.options.pos.y=200;
...
//                $dialog.hide();
//            });
            mc.text(ops.text, ops.options).draw({
                success: function success(b64) {
                    picLink = b64;
                    linkArr.push(picLink);
                    $result.attr('src', b64);
                    $dialog.hide();
                    lock = false;
//                    console.log(picLink)
...
function showDialog(type, ops) {
    ...
    switch (type) {
        ...
        case 'watermark':
            ...
            break;
        case 'text':
//            html='<li>text:<input data-type=\'x\' class=\'js-input input writeWord\' type=\'text\' value=\'中国电信\'></li>\n                    ';
            html = '<li>text:<input data-type=\'x\' class=\'js-input input writeWord\' type=\'text\' value=\'中国电信\'></li>\n                    <li>选项:{</li>\n                    <li>' + tab + '画布宽度:<input data-type=\'width\' class=\'js-input input writeWidth\' type=\'text\' value=\'' + ops.options.width + '\'></li>\n                    <li>' + tab + '位置:\n                        <select data-type=\'align\' class=\'js-select selectTar\'>\n                            <option  value = "left">left</option>\n                            <option  value = "center"></option>\n                            <option value = "right">right</option>\n                        </select>\n                    </li>\n                    <li>' + tab + 'pos:{\n                    <li>' + (tab + tab) + 'x:<input data-type=\'x\' class=\'js-input input\' type=\'text\' value=\'' + ops.options.pos.x + '\'></li>\n                    <li>' + (tab + tab) + 'y:<input data-type=\'y\' class=\'js-input input\' type=\'text\' value=\'' + ops.options.pos.y + '\'></li>\n                    <li>' + tab + '}</li>\n                    <li>}</li>';
//            <input data-type=\'x\' class=\'js-input input\' type=\'text\' value=\'中国电信\'>
//            <span style="font-size:12px;">\'\'&lt;b&gt;Large/Stroke&lt;/b&gt;Normal/Gradient&lt;s&gt;Small/Shadow&lt;/s&gt;\'\'</span>
            break;
        default:
    }
