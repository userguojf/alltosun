...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        UEDITOR_HOME_URL : URL+'/js/ueditor1_2_6_1/'

        //图片上传配置区
        ,imageUrl:URL+"/core/handler/file_uploader?res_name=photo&source=ueditor"             //图片上传提交地址
        ...
        , toolbars:[["fullscreen", "source", "|", "undo", "redo", "|", "bold","italic","underline","|","insertorderedlist","insertunorderedlist","|","insertimage","|",'removeformat','forecolor','backcolor',"insertvideo","|", "link", "unlink"]]
        /*, toolbars:[
