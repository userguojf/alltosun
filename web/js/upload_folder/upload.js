 ...
 */
        //允许的文件类型
        var arrType = ['jpg','png', 'jpeg','gif', 'mp3','mp4', 'xls' ,'doc' , 'ppt' , 'csv' ];// 'vnd.ms-excel']; 
        ...
        //获取后台地址的路径
        var awifi_url = document.getElementById("awifi_url").src.split('/js')[0];
        //接收上传文件的后台地址
        var folder_url = awifi_url + "/download/admin/js_save"; 
...
//            console.log(fileObj.type.split('/').pop());
//            return ;
            //判断文件类型不被允许
...
//            ,1500);
        ...
        function format_bool(){
            alert("请重新选择文件，允许的文件类型有jpg , png , jpeg , gif , mp3 , mp4");
        }
