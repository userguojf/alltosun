...
var imgurl = picUrl + "/images/homework/money.jpg";
staticProperty.shareData={
    title:"让真学霸都膜拜的暑假作业，我竟然做完了",
    link:"http://www.pzclub.cn/event/homework",//分享链接
    desc:"让真学霸都膜拜的暑假作业，我竟然做完了",
...
staticProperty.wxShare=function(shareData,_isLoadSdk)
{
    ...
    function wxShare()
    {
        function getJSSDKData(backFun){
        	var Url = siteUrl+'/homework/get_ticket';
            $.ajax({
                url: Url,
                type: "post",
