			...
			var _SELF = $(this),
				...
				object = function(length){
					...
					this.NumBtnDom = function(list,w,h,l,t){
						return "<dl style=\"z-index:11;width:490px;height:53px;position:absolute;left:170px;top:-65px;\">"+ list +"</dl>";
					};
					this.arrow = function(l,r,w,h,x,y){
						return "<em class=\"sPrev\" id=\"sPrev\" style=\"position:absolute;cursor:pointer;z-index:10;width:16px;height:18px;\"></em><em class=\"sNext\" id=\"sNext\" style=\"position:absolute;cursor:pointer;z-index:10;width:16px;height:18px;\"></em>";
					};
					this.hoverDom = function(t,w,h,b,bg,p,c,lh){
						return "<div style=\"display:none;cursor:pointer;width:293px;height:233px;position:absolute;z-index:1;\"></div><b style=\"z-index:2;height:0px;overflow:hidden;\">"+ t +"</b>";
					};
				};
			//初始化获取DOM数据
