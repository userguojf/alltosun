...
class Action
{
    public function add_stat()
    {
        ...
        $res_id         = tools_helper::get('res_id', '73');
        $res_name       = tools_helper::get('res_name', 'photo');
    ...
    public function add_content_stat()
    {
        ...
        $info               = '[{"res_id":"28","res_name":"photo", "click_time":"'.date('Y-m-d H:i:s').'"}, {"res_id":"27","res_name":"photo", "click_time":"'.date('Y-m-d H:i:s').'"}]';
        // 生成接口基础数据
        $post_data = api_helper::make_test_base_data();
