...
class Action
{
    ...
    public function get_business()
    {
        ...
        //$api_url = 'http://mac.pzclub.cn/screen/api/4/business/get_business';
        $api_url = SITE_URL.'/screen/api/4/business/get_business';
    ...
    public function get_business_list()
    {
        ...
        $api_url = SITE_URL.'/screen/api/3/business/get_business_list';
        $res = an_curl($api_url, $post_data, 0, 0);
        echo $res;
