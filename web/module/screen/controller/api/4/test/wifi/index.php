...
//         echo $res;
    ...
    {
        $user_number    = tools_helper::get('user_number', '1101081002048');
        $device_unique_id     = tools_helper::get('device_unique_id', 'c40bcb1d0666');
        ...
        $post_data['user_number'] = '1101081002048';
        $post_data['device_unique_id'] = 'c40bcb1d0666';

        $api_url = SITE_URL.'/screen/api/2/wifi/get_device_wifi_info';
        //$api_url = 'http://mac.pzclub.cn/screen/api/2/wifi/get_device_wifi_info';
        $res = an_curl($api_url, $post_data, 0, 0);
        echo $res;
