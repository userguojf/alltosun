...
class Action
{
    ...
    {
        //P(_model('screen_device')->delete(array('id' => array(39,43,44))));
        //exit();
        $user_number    = tools_helper::get('user_number', '1101021002051'); //1101081002056 //1101081002058 //1101001011530
        $phone_imei     = tools_helper::get('phone_imei', '863409031900862');
        $phone_name     = tools_helper::get('phone_name', 'Xiaomi');
        $phone_version  = tools_helper::get('phone_version', 'MI MAX');
        $phone_mac      = tools_helper::get('phone_mac', 'c4:0b:cb:1d:06:67');
        ...
        $post_data['shoppe_id']    = 123;
        $post_data['registration_id']    = '13065ffa4e30c3d5bfb';


        an_dump($post_data);
        $api_url = SITE_URL.'/screen/api/3/phone/add_device_info';
        //$api_url = 'http://mac.pzclub.cn/screen/api/3/phone/add_device_info';
    ...
    public function get_device_unique_id()
    {
        ...
        $api_url = SITE_URL.'/screen/api/3/phone/get_device_unique_id';
        $res = an_curl($api_url, $post_data, 0, 0);
        echo $res;
