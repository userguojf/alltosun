...
class Action
{
    public function add_device_info()
    {
        ...
        //exit();
        $user_number    = tools_helper::get('user_number', '1101081002058'); //1101081002056 //1101081002058 //1101001011530
        ...
        $phone_mac      = tools_helper::get('phone_mac', 'c4:0b:cb:1d:06:66');
