...
//     }
    ...
    public function is_exist_type4()
    {
        ...
        if (! $device_info) {
            api_helper::return_api_data ( 1003, '设备已经不存在', array (), $api_log_id );
        }
        ...
        if ($content_info) {
            api_helper::return_api_data ( 1000, 'success', array ( 'info' => 'ok', 'exists' => 1), $api_log_id );
        } else {
            api_helper::return_api_data ( 1000, 'success', array ( 'info' => 'ok', 'exists' => 0 ), $api_log_id );
        }
    }
