<?php
/**
  * alltosun.com 联华设备数据处理 lianh.php
  * ============================================================================
  ...
  * $Id$
  */
class lianh extends BaseHandle
{
    //数据字段
    ...
    public function string_to_arr($string, $fd=NULL)
    {
        ...
        //处理MAC
        if ( isset($original_arr['ID']) && $original_arr['ID']) {
            $new_arr['MAC'] = $original_arr['ID'];
        } else {
            return array('errno' => 1001, 'msg' => '数据缺少ID');
        }
