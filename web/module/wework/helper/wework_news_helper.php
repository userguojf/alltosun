<?php
/**
 * alltosun.com  wework_news_helper.php
 * ============================================================================
 ...
 * $Date: 2018-5-8 下午3:27:37 $
 * $Id$
 */

class wework_news_helper
{
    ...
    public static function content_zan($res_id, $type)
    {
        ...
        $info = _uri('qydev_news_content_zan_record', 
            array(
                  ...
                  'unique_id'   => isset($_SESSION['wework_user_id']) && $_SESSION['wework_user_id'] ? $_SESSION['wework_user_id'] : '',
                  'type'        => 2,
             )
        );
