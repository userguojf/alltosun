 ...
 * $Date: 2017-4-6 下午7:04:12 $
 * $Id: token.php 340516 2017-04-07 02:24:41Z shenxn $
 */
...
class token_widget
{
    ...
    {
        $request_url = wework_config::$get_access_token_url;

        $url = $request_url.'corpid='.wework_config::$wework_corpid.'&corpsecret='.wework_config::$dls_agent_secret[$this->agent_id];
