<?php
/**
 * alltosun.com 微信企业号全局返回码说明封装 $errmsg.php
 * ============================================================================
    ...
    public function get_errmsg($errcode)
    {
        switch ($errcode) {
            ...
            case 60131:
                ...
                break;
            case 80001:
                $errmsg = "可信域名不匹配，或者可信域名没有IPC备案（后续将不能在该域名下正常使用jssdk）";
                break;
            case 81003:
                $errmsg = "邀请额度已用完";
                break;
            ...
            case 81011:
                ...
                break;
            case 82001:
                $errmsg = "发送消息或者邀请的参数全部为空或者全部不合法";
                break;
            case 82002:
                $errmsg = "不合法的PartyID列表长度";
                break;

            default:
                $errmsg = "企业微信返回码：".$errcode.'，请求失败';
                break;
        }
