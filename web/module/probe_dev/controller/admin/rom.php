...
/**
 * alltosun.com 探针rom管理 index.php
 * ============================================================================
...
class Action
{
    ...
    public function __call($action, $params = array())
    {
        ...
        $log_total = _model('probe_rom')->getTotal($filter);

        // 分页
        if ($log_total) {
            $pager = new Pager($this->per_page);
            $list  = _model('probe_rom')->getList($filter, $order . $pager->getLimit($page));
        ...
        Response::display('admin/rom.html');
    }

    public function add()
    {
        Response::display("admin/rom_add.html");
    }
