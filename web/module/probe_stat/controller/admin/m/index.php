...
// an_dump($return);
        ...
        Response::display('admin/m/index.html');
    }
    ...
    public function region_list()
    {
        ...
        Response::display('admin/m/region_list.html');
    }
    ...
    public function mac_list()
    {
        ...
        Response::assign('type', $type);
        Response::assign('list', $list);
        Response::display('admin/m/mac_list.html');
    }
    ...
    public function mac_detail()
    {
        ...
        Response::assign('list', $list);
        Response::display('admin/m/mac_detail.html');
    }
    ...
    public function hour_list()
    {
        ...
        if ( $type == 5 ) {
            Response::display('admin/m/list_week.html');
        } else {
            Response::display('admin/m/list_hour.html');
        }
    }
}
?>
