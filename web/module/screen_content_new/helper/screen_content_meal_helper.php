...
class screen_content_meal_helper
{
    ...
    public static function delete_set_meal_by_content_id($content_id)
    {
        ...
        //获取所有内容关联
        $content_res_list = screen_content_new_helper::get_content_res_list(array('content_id' => $content_id));

        //删除所有内容关联
        screen_content_new_helper::delete_content_res(array('content_id' => $content_id));
