...
class put_widget
{
     ...
     public function put_content($param=array())
     {
        ...
        /* if (is_array($result)) {
             foreach ($result as $v) {
                 //推送
                 $this->push_by_content_res(_uri('screen_content_res', $v), '2');
             }
         } else {
             $this->push_by_content_res(_uri('screen_content_res', $result), '2');
         }*/
     ...
     /**
      * 2018-03-05 wangjfadd  此方法将会被弃用， 由 push_by_content_res()来替代
      * 根据发布内容获取要发布的极光推注册id
      * @param unknown $content_res
      */
